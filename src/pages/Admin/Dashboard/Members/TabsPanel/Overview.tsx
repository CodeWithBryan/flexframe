...
const Overview: React.FC = () => {
  return (
    <div className='w-full p-4 grid grid-cols-[2fr,1fr] gap-5'>
      {/* LEFT PORTION ==================> */}
      <div className='w-full flex flex-col gap-4'>
        {/* top-statistics ----> */}
        <div className='w-full bg-white-1 p-4 border-[1px] flex justify-between items-center border-[#E2E4E9] rounded-[16px]'>
          {generalStatistics.map((sta, index) => {
            return (
              <div key={index} className='flex flex-col gap-2 items-start'>
                ...
                <h2 className='text-[24px] font-medium text-[#0A0D14] font-inter'>
                  {sta.value}
                </h2>
              </div>
            );
        ...
        <div className='w-full h-[300px] rounded-[16px] bg-orange-400'></div>
        {/* Notes + Documents --------> */}
        <div className='w-full grid grid-cols-2 gap-4'>
          ...
          <div className='w-full bg-white-1 p-4 border-[1px] flex flex-col gap-3 border-[#E2E4E9] rounded-[16px]'>
            <div className='w-full flex justify-between items-center'>
              ...
              <button className='flex hover:bg-white-3 justify-center px-2 py-[2px] rounded-[64px] bg-white-1 border-[1px] border-[#E2E4E9] items-center gap-2'>
                <Icons.Plus className='w-[12px] h-[12px]' />
          ...
          <div className='w-full bg-white-1 p-4 border-[1px] flex flex-col gap-5 border-[#E2E4E9] rounded-[16px]'>
            <div className='w-full flex justify-between items-center'>
              ...
              <button className='flex hover:bg-white-3 justify-center px-2 py-[2px] rounded-[64px] bg-white-1 border-[1px] border-[#E2E4E9] items-center gap-2'>
                <Icons.Plus className='w-[12px] h-[12px]' />
                <p className='text-[14px] text-[#525866] font-medium'>Upload</p>
              </button>
            </div>
            {/* files  */}
              ...
              {[0, 1].map((fil, index) => {
                return (
                  ...
                  >
                    ...
                    <Icons.Download className='w-[29px] h-[30px]' />
                  </div>
                );
              })}
            </div>
            ...
            {userProfile.size.map((item, index) => {
              return (
                <div key={index} className='flex flex-col'>
                  ...
                  <h3 className='text-[20px] font-normal text-[#0A0D14]'>
                    {item.value}
                  </h3>
                </div>
              );
