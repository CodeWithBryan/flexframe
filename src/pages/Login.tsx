        ...
        <div className='w-full max-w-[420px] flex flex-col gap-3 px-4 sm:px-8 h-full justify-center items-center'>
          ...
          <form onSubmit={handleLogin} className='flex flex-col gap-3 mt-2 sm:mt-4 items-start w-full'>
            ...
            <div className='w-full flex flex-col gap-2'>
              <label className='text-[14px] text-[#0A0D14] font-medium'>Email</label>
              <Input
                value={signIn.email}
                type='text'
                name='email'
            ...
            {/* Password */}
            <div className='w-full flex flex-col gap-2'>
              <label className='text-[14px] select-none text-[#0A0D14] font-medium'>
                Password
              </label>
              <PasswordField
          ...
          <Typography.mText styles='font-medium text-[#525866]'>
            Not a member yet?{' '}
            <Link to='/signup' className='text-red-1 hover:opacity-80 font-semibold'>
              Sign up
            </Link>
          </Typography.mText>
