  ...
  return (
    <ComponentWrapper style='py-10'>
      <div className='w-full flex flex-col gap-4 justify-center items-center' id="training">
        ...
        We are dedicated to helping you achieve your fitness goals. Our personalized training programs cater to all fitness levels and offer specialized expertise in body transformation, weight loss, bodybuilding, and competition preparation.
        </Typography.text>
        {/* programs =========>  */}
